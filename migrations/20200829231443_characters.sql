...
CREATE TABLE IF NOT EXISTS characters (
    ...
    account_id INT CONSTRAINT fk_account REFERENCES accounts(account_id) ON DELETE CASCADE,
    realm_id INT CONSTRAINT fk_realm REFERENCES realms(realm_id),
    name VARCHAR(15) UNIQUE NOT NULL,
    mesh INT NOT NULL DEFAULT 1003,
    avatar SMALLINT NOT NULL DEFAULT 1,
    hair_style SMALLINT NOT NULL DEFAULT 535,
    silver INT NOT NULL DEFAULT 1000 CHECK ( silver >= 0 ),
    cps INT NOT NULL DEFAULT 0 CHECK ( cps >= 0 ),
